...
var BOARD_SHAKE_ANIM_INDEX_LOOKUP = [];
...
export var LevelComponent = (function () {
    function LevelComponent(router, gameStateService, soundService) {
        this.router = router;
    ...
    LevelComponent.prototype.initSquares = function (level) {
        var _this = this;
        var levelData = this.puzzles[level - 1];
        ...
        this.squares.map(function (square) {
            square.state = _this.getStateWithRandomNum(square.selected ? 'selected' : 'unselected');
            return square;
        });
        // init. board rows
        this.boardRows = [];
        for (var row_1 = 0; row_1 < 5; row_1++) {
            var j = row_1 * 5;
            this.boardRows.push(this.squares.slice(j, j + 5));
        }
    };
    LevelComponent.prototype.boardRowTrackByFn = function (index) {
        return index;
    };
    LevelComponent.prototype.squareTrackByFn = function (index, square) {
        return square.id;
    };
    LevelComponent.prototype.getStateWithRandomNum = function (state) {
        return state + this.getRandomInt(1, 3);
    };
    // Returns a random integer between min (inclusive) and max (exclusive)
    LevelComponent.prototype.getRandomInt = function (min, max) {
    ...
    LevelComponent.prototype.shakeBoardForReset = function () {
        this.startShakingBoard(9);
    };
    LevelComponent.prototype.shakeBoardForClickedSquare = function (row, col) {
        var boardShakeAnimationIndex = BOARD_SHAKE_ANIM_INDEX_LOOKUP[row][col];
        this.startShakingBoard(boardShakeAnimationIndex);
    };
    LevelComponent.prototype.startShakingBoard = function (boardShakeAnimationIndex) {
        var _this = this;
        this.isBoardShaking[boardShakeAnimationIndex] = true;
        setTimeout(function () { _this.stopShakingBoard(); }, 400);
    };
    LevelComponent.prototype.stopShakingBoard = function () {
        this.isBoardShaking = this.isBoardShaking.map(function () { return false; });
    };
    ...
    LevelComponent.prototype.indexToCoords = function (index) {
        return { row: Math.floor(index / 5), col: (index % 5) };
    };
    LevelComponent.prototype.coordsToIndex = function (coords) {
        return (coords.row * 5) + coords.col;
    };
    LevelComponent.prototype.adjustedCoords = function (coords, rowDiff, colDiff) {
        return {
            row: coords.row + rowDiff,
            col: coords.col + colDiff
        };
    };
    LevelComponent.prototype.calcSquaresToToggle = function (index) {
        var indexes = [index];
    ...
    LevelComponent.prototype.initLevel = function (selectedLevel) {
        ...
        var isLevelSolved = this.isLevelPreviouslySolved(selectedLevel);
        ...
        var numStarsEarned = this.calcNumStarsEarned(this.gameState.selectedLevel, this.gameState.bestSolution);
    ...
    LevelComponent.prototype.isLevelPreviouslySolved = function (level) {
        return (level <= this.bestSolutions.length);
    };
    LevelComponent.prototype.updateBestSolutions = function () {
    ...
    LevelComponent.prototype.gameWon = function () {
        ...
        var numStarsEarned = this.calcNumStarsEarned(this.gameState.selectedLevel, this.gameState.movesTaken);
    ...
    LevelComponent.prototype.calcNumStarsEarned = function (level, playersSolution) {
        var bestSolution = this.solutions[level - 1].length;
    ...
    LevelComponent.prototype.getSquareIndex = function (row, col) {
        return (row * 5) + col;
    };
    LevelComponent.prototype.clickSquare = function (row, col) {
    ...
    LevelComponent.prototype.mouseEnterSquare = function (row, col) {
        var squareIndex = this.getSquareIndex(row, col);
        this.soundService.playBlipSound();
        this.setSquareHoverState(squareIndex, true);
    };
    LevelComponent.prototype.mouseLeaveSquare = function (row, col) {
        var squareIndex = this.getSquareIndex(row, col);
        this.setSquareHoverState(squareIndex, false);
    };
    LevelComponent.prototype.setSquareHoverState = function (squareIndex, isHover) {
    ...
    LevelComponent = __decorate([
        ...
        __metadata('design:paramtypes', [Router, GameStateService, SoundService])
    ], LevelComponent);
